...
public class ScrollablePanel extends FrameLayout {
    ...
    private void initView() {
        LayoutInflater.from(getContext()).inflate(R.layout.scrollable_panel_view, this, true);
    ...
    private static class PanelLineAdapter extends RecyclerView.Adapter<PanelLineAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ViewHolder viewHolder = new ViewHolder(LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.scroll_panel_row_recycler_item, parent, false));
        ...
        static class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(View view) {
                ...
                LinearLayoutManager layoutManager = new StopAutoLayoutManger(view.getContext(), LinearLayoutManager.HORIZONTAL, false);
