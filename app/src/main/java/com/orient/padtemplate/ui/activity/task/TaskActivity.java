 ...
 */
public class TaskActivity extends BaseMvpActivity<TaskPresenter>
        implements TaskView {
    ...
    protected void initWidget() {
        ...
        mAdapter = new RecyclerAdapter<Flow>(null) {
            ...
            public ViewHolder<Flow> onCreateViewHolder(View root, int viewType) {
                return new TaskActivity.ViewHolder(root);
            }
        ...
        mAdapter.setAdapterListener(new RecyclerAdapter.AdapterListenerImpl<Flow>() {
            @Override
            public void onItemClick(RecyclerAdapter.ViewHolder<Flow> holder, Flow flow) {
                super.onItemClick(holder, flow);

                FlowActivity.show(TaskActivity.this);
            }
        });
