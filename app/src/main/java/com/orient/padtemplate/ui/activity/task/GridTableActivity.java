 ...
 */
public class GridTableActivity extends BaseMvpActivity<GridTablePresenter>
    ...
    public static void show(Context context){
        Intent intent = new Intent(context,GridTableActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.grid_table_activity;
    }
    ...
    public void onInitLoadResult(List<Cell> titles, List<Cell> contents) {
        ...
        mAdapter = new GridTableAdapter(titles, contents, this, true, this);
